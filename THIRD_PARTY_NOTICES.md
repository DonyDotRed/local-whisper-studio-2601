...
- **Transformers.js** (`@huggingface/transformers` 3.8.1) — Apache-2.0. Loaded from jsDelivr; model files are loaded from Hugging Face Hub and cached by the browser when supported.
